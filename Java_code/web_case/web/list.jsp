...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/delSelectServlet" method="post" id="form">
        ...
        <c:forEach items="${requestScope.BeanPage.list}" var="user" varStatus="s">
            <tr>
    ...
    <nav>
        <ul class="pagination">
            ...
            <c:if test="${BeanPage.currentPage != 1}">
                ...
                <a href="${pageContext.request.contextPath}/findUserByPageServlet?currentPage=${BeanPage.currentPage - 1}&rows=5&name=${condition.name[0]}&address=${condition.address[0]}&email=${condition.email[0]}" aria-label="Previous">
            ...
            <c:if test="${BeanPage.currentPage != BeanPage.totalPage}">
                ...
                <a href="${pageContext.request.contextPath}/findUserByPageServlet?currentPage=${BeanPage.currentPage + 1 >= BeanPage.totalPage ? BeanPage.totalPage : BeanPage.currentPage + 1}&rows=5&name=${condition.name[0]}&address=${condition.address[0]}&email=${condition.email[0]}" aria-label="Next">
                    <span aria-hidden="true">&raquo;</span>
                </a>
            </li>
            <span style="font-size: 24px; margin-left: 5px">共${BeanPage.totalCount}条记录，共${BeanPage.totalPage}页</span>
        </ul>
    </nav>
</div>
</body>
