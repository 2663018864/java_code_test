...
<div class="container" style="width: 400px;">
    ...
    <form action="${pageContext.request.contextPath}/updateUserServlet" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" value="${user.qq}" class="form-control" id="qq" name="qq" placeholder="请输入QQ号码"/>
        </div>

        <div class="form-group">
            <label for="email">Email：</label>
            <input type="text" value="${user.email}" class="form-control" id="email" name="email" placeholder="请输入邮箱地址"/>
        </div>
